...
SELECT pg_catalog.setval('public.spielsession_sessid_seq', 43, true);
...
ALTER TABLE ONLY public.userfound
    ADD CONSTRAINT userfound_pkey PRIMARY KEY ("time");
...
ALTER TABLE ONLY public.userfound
    ADD CONSTRAINT userfound_sessid_fkey FOREIGN KEY (sessid) REFERENCES public.spielsession(sessid);
